            ...
            <div style="display: flex;align-items: center;" >
                <nav>
                    <ul>
                        ...
                        <li><a href="unreserve">立即預約</a></li>
                        <li><a href="unshop">美容用品</a></li>
                        <li><a href="login">購物車</a></li>
                        <li><a href="login">訂單/預約查詢</a></li>
                ...
                @if (Route::has('login'))
                    <div  style="position: absolute;z-index: 1;left: 90%;">
                        @auth
                            <a href="{{ url('/dashboard') }}" style="" >首頁</a>
                        @else
                            <a href="{{ route('login') }}" style="color:rgb(17 24 39 );text-decoration: none;" >登入</a>
                        @endauth
                    </div>
                @endif
            </div>
